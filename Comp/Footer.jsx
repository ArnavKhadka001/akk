...
<div className="container-fluid my-5"  style={{backgroundColor: '#23242a'}}>
    ...
    <div className="container p-4">
      ...
      <div className="row mt-4">
        ...
        <div className="col-lg-4 col-md-12 mb-4 mb-md-0">
          ...
          <div className="mt-4">
            {/* Facebook */}
            <a type="button" className="btn btn-floating btn-warning btn-lg"><i className="fab fa-facebook-f" /></a>
            {/* Dribbble */}
            <a type="button" className="btn btn-floating btn-warning btn-lg"><i className="fab fa-dribbble" /></a>
            {/* Twitter */}
            <a type="button" className="btn btn-floating btn-warning btn-lg"><i className="fab fa-twitter" /></a>
            {/* Google + */}
            <a type="button" className="btn btn-floating btn-warning btn-lg"><i className="fab fa-google-plus-g" /></a>
            {/* Linkedin */}
          </div>
        </div>
        {/*Grid column*/}
